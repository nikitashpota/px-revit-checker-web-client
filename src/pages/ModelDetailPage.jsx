...
import LevelsReportSection from '../components/LevelsReportSection'
...
export default function ModelDetailPage() {
  ...
  const directoryId = model.directory_id || dirId
  ...
  return (
    <div>
      <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4">
        ...
        <span>/</span>
        <Link to={`/directory/${directoryId}`} className="hover:text-blue-600">
      ...
      {section === 'levels' && <LevelsReportSection modelId={modelId} />}
